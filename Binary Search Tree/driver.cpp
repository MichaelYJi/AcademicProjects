...
int main() {
  cout << "my getHeight finds height based off the book" << endl;
  cout << "the root is 1 and each level down is +1"  << endl;
  cout << endl;
...
//------------------------------- buildTree ----------------------------------
// Builds a binary tree based off strings from the input data file.
// Precondition: valid text file and valid BinTree input.
// Postcondition: fills the binary search tree with data from text file.
