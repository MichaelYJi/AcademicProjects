...
//**  Author: Michael Ji
//**  Methods done: format, close, delete
//******************************************************************************
public class FileSystem {
    ...
    {
        /*
        The files argument passed to format indicates the maximum number of inodes.
        If files is 48, #inodes is 48.
        This means, 48/16 = 3 blocks will be allocated to maintain those 48 inodes.
        Then, you can see:
        block #0: superblock
        block #1: inodes 0 - 15
